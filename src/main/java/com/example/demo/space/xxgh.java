...
public class xxgh {
  private static final double[][] A = {
      {7.592992,
          ...
          2.8703999999999996,
          1.5},
      {2.1, 0.2, 0.7, 1.8, 1.3, 0.3, 0.23, 1.2, 0.9, 0.3},


  };// 系数矩阵

  private static final int m = A.length; //m个方程
  private static final int n = A[0].length; //n个决策变量

  private static final double[] C = {7.592992,
      1.1576250000000001,
      5.712339999999999,
      5.0672999999999995,
      2.40597,
  ...
  private static final double[] b =
      {18 * 8.45 * 13.40 + 20 * 8.45 * 14.80 + 16 * 8.45 * 12.60, 10 + 16 + 8};
  // 资源常数

  private static final double[] theta = new double[m]; //b的检验数

  private static final int[] basedVar = new int[m]; // 基变量，存基变量的下标，从1开始标号（区别于数组存储习惯）

  private static final double[] yita = new double[n]; //检验数，有n个决策变量的检验数
